...
<main class="catalog">
    ...
    <section class="catalog__product page__block pt0">
        <div class="container">
            ...
            <div class="catalog__product-tabs tabs-field">
                <div class="catalog__product-tabs-names text_fz24">
                    <span class="tabs-name active">Описание</span>
                    <span class="tabs-name">Доставка</span>
                    <span class="tabs-name">Оплата</span>
                </div>
                <div class="catalog__product-tabs-content tabs-content default-text active">
                ...
                <div class="catalog__product-tabs-content tabs-content default-text">
                    <h3>по Москве</h3>
                    <ul class="ul-images">
                        <li>
